...
/**
 * Napisy modułu zadania ćwiczebnego — **rozwiązanie**.
 *
 * Wobec pliku startowego zmieniło się jedno: **obok stoi `en.php`**. Katalog
 * modułu, który przetłumaczył się na jeden język, jest w tym projekcie takim
 * samym błędem, co napis wpisany wprost w kod — pilnuje tego
