# Krok 61 — Porządek: jedno źródło, dwa języki, jedna konwencja rysunku
...
- **Kroki 62–65** — wszystkie zależą od tego kroku i żaden nie da się zacząć
  wcześniej.
...
a broni go **test z kroku 65**: każdy numer reguły w `SKILL.md` ma rozdział
...
dokumentów: podręcznik (krok 62), przewodnik (63) i onboarding (64).
...
została w tyle, jest **usterką widoczną w bramce jakości** (krok 65), a nie
stanem normalnym.
...
65 pilnuje, że wskazywany zakres istnieje.
...
- **Pisanie samych treści** — podręcznik, przewodniki i onboarding należą do
  kroków 62–64; ten krok stawia szkielet i granice.
