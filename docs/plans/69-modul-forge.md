# Krok 69 — Moduł `forge`: PR-y, zgłoszenia i przeglądy zespołu
...
(`kubectl`, `ssh`) i — od kroku 60 — z rejestrem obrazów po HTTP. **Serwis
...
HTTP, dla której wzorem jest krok 60, nie krok 51: tam gniazdo jest lokalne
...
- **Różnica** — treść zmiany w `TextView`, wzorem widoku różnicy z kroku 66.
...
- **Krok 66** — gałąź i zatwierdzenie katalogu, na których stoi użytkownik.
- **Krok 60** — rozmowa HTTP z uwierzytelnieniem jako najbliższy wzór.
