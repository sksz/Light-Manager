# Krok 71 — Moduł `http`: endpointy aplikacji i pytanie „czy to jeszcze żyje"
...
z nich — miejsce na sekret — jest wspólne z krokiem 70 i rozstrzyga się tam.
...
2. **Sekrety w zapytaniach** — token w nagłówku to ten sam problem, co
   w kroku 70, i rozstrzyga się razem z nim.
...
**Opus / high.** Nowego rodzaju rozmówcy nie wnosi, jeśli krok 70 rozstrzygnie
