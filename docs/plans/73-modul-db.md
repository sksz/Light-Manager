# Krok 73 — Moduł `db`: bazy danych, do których zagląda się w trakcie pracy
...
miejsce na sekret — jest wspólne z krokiem 69 i rozstrzyga się tam.
...
3. **Miejsce na sekret** — jak w kroku 69; hasło do bazy jest tym samym
   problemem, co token.
