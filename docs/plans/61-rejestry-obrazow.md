...
- **Krok 60** — książka adresowa. Zależność **do rozstrzygnięcia, nie
  przesądzona** (pytanie 5 tamtego kroku): rejestr jest adresem
  z poświadczeniem, więc albo jego adres jest wpisem książki, a poświadczenie
  zostaje u modułu Dockera — albo rejestry dostają **własny** spis, co postawi
  wzorzec książki po raz czwarty i po D103 wymaga uzasadnienia.
