# Krok 67 — Moduł `git`: repozytorium przestaje być niewidzialne
...
następnych stoją na jego kwerendach.** Moduł `team` (krok 75) nie ma bez niego
z czego liczyć wkładu, moduł `forge` (krok 70) potrzebuje wiedzieć, na jakiej
