...
return [
    ...
    'module.docker.query.registries' => 'Rejestry obrazów: adres, użytkownik, czy jest token',
    ...
    'module.docker.view.registry' => 'Rejestr',
    'module.docker.registry.header.none' => 'Nie wybrano rejestru',
    'module.docker.registry.header.working' => '{registry} — {stage}',
    'module.docker.registry.header.catalog' => '{registry} — zawartość',
    'module.docker.registry.header.tags' => '{registry} — etykiety obrazu {image}',
    'module.docker.registry.empty.none' => 'Nie ma żadnego rejestru — dopisz go w książce adresowej (Ctrl+W).',
    'module.docker.registry.empty.idle' => 'Ctrl+R pobiera spis obrazów, F7 pyta o nazwę obrazu.',
    'module.docker.registry.empty.needsName' => 'Ten rejestr nie wystawia spisu obrazów — podaj nazwę obrazu (F7), a pokażę jego etykiety.',
    'module.docker.registry.empty.nothing' => 'Rejestr jest pusty.',
    'module.docker.registry.prompt' => 'Nazwa obrazu w rejestrze',
    'module.docker.registry.key.open' => 'pokaż etykiety obrazu',
    'module.docker.registry.key.open.short' => 'etykiety',
    'module.docker.registry.key.name' => 'podaj nazwę obrazu',
    'module.docker.registry.key.name.short' => 'nazwa',
    'module.docker.registry.key.refresh' => 'pobierz ponownie',
    'module.docker.registry.stage.idle' => 'nikt jeszcze nie pytał',
    'module.docker.registry.stage.asking' => 'pytam rejestr',
    'module.docker.registry.stage.authenticating' => 'pobieram token',
    'module.docker.registry.stage.retrying' => 'pytam ponownie z tokenem',
    'module.docker.registry.stage.done' => 'gotowe',
    'module.docker.registry.stage.failed' => 'nie udało się',
    'module.docker.registry.unreachable' => 'Rejestr nie odpowiada.',
    'module.docker.registry.denied' => 'Rejestr odrzucił poświadczenia — sprawdź użytkownika i token w książce adresowej.',
    'module.docker.registry.unsupported' => 'Rozmowa z rejestrem wymaga rozszerzenia ext-curl.',
    'module.docker.registry.none' => 'Nie wybrano rejestru.',
    'module.docker.query.catalog' => 'Zawartość rejestru: obrazy albo etykiety',
    'module.docker.command.pull' => 'Pobiera obraz z rejestru',
    'module.docker.query.pull' => 'Stan pobierania obrazu',
    'module.docker.query.registrySecret' => 'Poświadczenie rejestru dla klastra',
    'module.docker.query.registrySecret.arg' => 'rejestr',
    'module.docker.pull.image' => 'Nazwa obrazu do pobrania',
    'module.docker.pull.title' => 'Pobieranie {tag}',
    'module.docker.pull.stage' => 'pobieram warstwy',
    'module.docker.pull.busy' => 'Pobieranie już trwa — poczekaj, aż się skończy.',
    'module.docker.pull.noImage' => 'Podaj nazwę obrazu do pobrania.',
    'module.docker.pull.started' => 'Pobieram {tag}.',
    'module.docker.pull.done' => 'Pobrano {tag}.',
    'module.docker.pull.cancelled' => 'Pobieranie przerwane.',
    'module.docker.pull.failed' => 'Nie udało się pobrać obrazu.',
    'module.docker.pull.rejected' => 'Rejestr odmówił pobrania: {reason}',
    'module.docker.registry.noCredentials' => 'Ten rejestr nie ma zapisanych poświadczeń — uzupełnij je w książce adresowej.',
    'module.docker.registry.chapter' => 'Rejestr obrazów',
    'module.docker.registry.field.address' => 'Adres rejestru',
    'module.docker.registry.field.user' => 'Użytkownik',
    'module.docker.registry.field.token' => 'Token',
    'module.docker.registry.field.insecure' => 'Bez TLS (sieć lokalna)',
    'module.docker.registry.field.default' => 'Domyślny',
    'module.docker.registry.invalidAddress' => 'Adres rejestru „{address}” nie jest adresem, którym da się nazwać obraz.',
    'module.docker.push.registry' => 'Do którego rejestru wypchnąć?',
    'module.docker.push.noRegistry' => 'Nie ma żadnego rejestru — dopisz go w książce adresowej (Ctrl+W).',
