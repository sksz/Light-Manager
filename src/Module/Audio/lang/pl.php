...
return [
    ...
    'module.audio.query.playlist' => 'pozycje playlisty wraz z brakującymi plikami',
    'module.audio.query.now-playing' => 'co gra, w jakim trybie i czy jest czym grać',
    'module.audio.query.effects' => 'przypisania dźwięków do zdarzeń aplikacji',
