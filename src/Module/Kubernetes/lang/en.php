...
return [
    ...
    'module.k8s.stage.noContext' => 'No cluster is selected — press c and pick one from the list.',
    ...
    'module.k8s.key.context' => 'Change context in this file',
    'module.k8s.key.context.short' => 'context',
    ...
    'module.k8s.stage.missingFile' => 'File {path} is missing — fix the entry path (c) or mount the disk.',
    'module.k8s.stage.unknownContext' => 'File {path} has no context {context} — pick another one with k.',
    'module.k8s.panel.clusters' => 'Clusters',
    'module.k8s.view.clusters' => 'Cluster — list',
    'module.k8s.key.clusters' => 'Cluster list',
    'module.k8s.key.clusters.short' => 'clusters',
    'module.k8s.cluster.column.name' => 'Name',
    'module.k8s.cluster.column.context' => 'Context',
    'module.k8s.cluster.column.kubeconfig' => 'File',
    'module.k8s.cluster.column.origin' => 'Origin',
    'module.k8s.cluster.column.state' => 'State',
    'module.k8s.cluster.origin.own' => 'own entry',
    'module.k8s.cluster.origin.config' => 'default file',
    'module.k8s.cluster.origin.env' => 'KUBECONFIG',
    'module.k8s.cluster.state.current' => 'current',
    'module.k8s.cluster.state.shadowed' => 'shadowed',
    'module.k8s.cluster.empty' => 'The cluster list is empty — add an entry with F7.',
    'module.k8s.cluster.reading' => 'Reading kubeconfig files…',
    'module.k8s.cluster.switched' => 'Cluster: {name}.',
    'module.k8s.cluster.removed' => 'Entry {name} removed from the list.',
    'module.k8s.cluster.saved' => 'Entry {name} saved.',
    ...
    'module.k8s.cluster.prompt.name.field' => 'name',
    'module.k8s.cluster.prompt.kubeconfig' => 'Kubeconfig file',
    'module.k8s.cluster.prompt.kubeconfig.field' => 'path',
    'module.k8s.cluster.prompt.context' => 'Context in this file',
    'module.k8s.cluster.prompt.context.field' => 'context',
    'module.k8s.cluster.prompt.namespace' => 'Namespace (empty — the one from the file)',
    'module.k8s.cluster.prompt.namespace.field' => 'namespace',
