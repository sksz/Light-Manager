...
return [
    ...
    'module.k8s.setting.context' => 'Zapamiętany kontekst',
    'module.k8s.setting.namespace' => 'Zapamiętana przestrzeń nazw',

    // Stany rozmowy z klastrem.
    'module.k8s.stage.unknown' => 'Klaster jeszcze niepytany.',
    'module.k8s.stage.reading' => 'Pytam klaster…',
    'module.k8s.stage.noContext' => 'Żaden kontekst nie jest bieżący — naciśnij c i wybierz klaster.',
    ...
    'module.k8s.key.context' => 'Wybierz klaster',
    'module.k8s.key.context.short' => 'klaster',
