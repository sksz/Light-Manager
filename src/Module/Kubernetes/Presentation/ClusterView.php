 ...
 *
 * **Jeden ekran w czterech postaciach** (trzech do kroku 59), wzorem kroku 49
 * i 51 i z tego samego powodu: `ScreenStack` liczy ekrany po tożsamości, a użytkownik widzi jedno
...
enum ClusterView
{
    ...
    /** Spis klastrów na całym ekranie (krok 59) — czwarta postać. */
    case Clusters;
